...
We'll also make exceptions to these rules, for the annual [RSC Twitter Poster Conference](https://blogs.rsc.org/rscpublishing/2019/05/24/rsc-poster-2020/), where we encourage London-based delegates to tag their poster with [#LdnChemEvents](https://twitter.com/search?q=%23ldnchemevents&src=typed_query&f=live), so we can the latest exciting local developments.
